...
CREATE TABLE `uomconversion` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_fromUomid_idx` (`fromUomid`),
  KEY `fk_toUomid_idx` (`toUomid`),
  CONSTRAINT `fk_fromUomid` FOREIGN KEY (`fromUomid`) REFERENCES `uom` (`id`),
  CONSTRAINT `fk_toUomid` FOREIGN KEY (`toUomid`) REFERENCES `uom` (`id`)
