...
CREATE TABLE `intransit` (
  ...
  `diliveryDate` datetime DEFAULT NULL,
  `sendoutDate` datetime DEFAULT NULL,
  `lotCost` int DEFAULT NULL,
  `orderNumber` int DEFAULT NULL,
  `sourceFrom` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`sku`)
...
LOCK TABLES `intransit` WRITE;
/*!40000 ALTER TABLE `intransit` DISABLE KEYS */;
/*!40000 ALTER TABLE `intransit` ENABLE KEYS */;
UNLOCK TABLES;
